...
int main()
{
    ...
    do{
        ...
        switch(operand)
        {
            case 'a': add_num(parameter, &cur_number); break;
            case 's': subtr_num(parameter, &cur_number); break;
            case 'f': add_double(parameter, &cur_number); break;
            case 'r': cout<<cur_number<<endl; break;
            case 'g': get_google_link(parameter, search_string); 
					  cout<<search_string<<endl; break;
            case 'p':   get_palindrome(parameter);  
                        break; 
            case 'm': get_address(parameter); break;
            default : cout<<"wtf\n"; break; 
        }
